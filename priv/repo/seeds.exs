...
Repo.insert!(%Contribution{
  ...
  description:
    "Pull Request für einen Bugfix des offiziellen OpenShift Ansible Playbooks. Das Playbook dient der Installation und Konfiguration von OpenShift 3"
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Webformulare mit JSON verwalten. Nach langem zögern habe ich mein Projekt nun veröffentlicht."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "ImportPhotoFolder ist ein Script, welches eine verschachtelte Orderstruktur als Alben in OS X Fotos importiert. Dazu ein Issue geschlossen, welches aufgrund des mangelhaften APIs von Fotos nicht umgesetzt werden kann."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Update vom Readme von meinem kleinen Skript zum Wireless Streaming der Sony PXW-X70 Kamera."
})
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 02},
  link:
    "https://github.com/amsibamsi/opengl-examples/commit/6f2dfc6c6b3facf6899083888c239edbf777d2fb",
  description:
    "Added simple color fill example with OpenGL ES 2.0 written in Go, based on previous example."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Habe in der Dokumentation zu Swiss Admin Styleguide einen veralteten Link bezüglich Accessbility gefunden und mit einem Pull Request korrigiert."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Heute stelle ich meine EmberJS Applikation rocketsled der Öffentlichkeit zur Verfügung. Im Dezember sind noch diverse weitere Commits zu diesem Projekt vorgesehen."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Ich habe heute für die OpenShift V3 hexboard Demo Applikation so angepasst, dass sie mit dem API für die Version 3.1 funktioniert."
})
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 02},
  link:
    "https://github.com/puzzle/flyway-cdi-integration/commit/43cf18082dfa5d6efd2455860f95d6d276d612a4",
  description:
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 03},
  link:
    "https://github.com/lbischof/puzzle-forms/commit/859c452187c1b918de1bb900533155eaaef2c926",
  description:
    "Damit Puzzle Forms einfach für interessierte zugänglich ist, habe ich ein Dockerfile erstellt. Das Frontend funktioniert noch nicht, da wegen der Restrukturierung Fehler entstanden sind."
})
...
Repo.insert!(%Contribution{
  ...
  description:
    "Ich habe schon vor zwei Jahren begonnen für mich ein Framework für Prototyping von Webapplikationen auf Basis von Meteor.js zu entwicklen. Ich habe die Advents Challenge als Anlass genommen, das Projekt endlich unter eine MIT Lizenz gestellt."
})
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 04},
  link:
    "https://github.com/puzzle/puppet-openshift3/commit/ae52fa675907f7a1323b3963282cda3850e9fad7",
  description:
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 04},
  link:
    "https://github.com/puzzle/opensource-advent-challenge-2015/commit/a09fb94b68611f431a13063f14fec8eb56ae1965",
  description:
    "Sicherstellen, dass die Advents Challenge Seite auf Handies nur in eine Richtung scrollt."
})
...
Repo.insert!(%Contribution{
  ...
  date: %Date{year: 2015, month: 12, day: 04},
  link:
    "https://linuxmonk.ch/wordpress/index.php/2015/setup-remote-server-management-of-a-supermicro-bmc-with-freeipmi-on-linux/",
