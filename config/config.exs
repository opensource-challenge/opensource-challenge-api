...
config :opensource_challenge, OpensourceChallengeWeb.Endpoint,
  ...
  render_errors: [
    view: OpensourceChallengeWeb.ErrorView,
    accepts: ~w(json json-api)
  ],
  pubsub: [name: OpensourceChallengeWeb.PubSub, adapter: Phoenix.PubSub.PG2]
...
config :opensource_challenge, OpensourceChallengeWeb.Guardian,
  allowed_algos: ["HS512"],
...
config :canary,
  repo: OpensourceChallenge.Repo,
  unauthorized_handler: {OpensourceChallengeWeb.AuthErrorHandler, :unauthorized}
